...
export default async function RootLayout({ children }) {
  ...
  return (
    <html lang="ar" dir="rtl">
      ...
      <body>
        <div style={{ background: '#E54E19', color: '#fff', textAlign: 'center', fontSize: 13, fontWeight: 700, padding: '4px 16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <div>
                ...
                <div style={{ marginTop: 1 }}>
                  <img src="/84.png" alt="orva" style={{ height: 24, width: 'auto', display: 'block' }} />
                </div>
              </div>
        ...
        <footer style={{ textAlign: 'center', padding: 20, color: '#8e8e93', fontSize: 13, borderTop: '1px solid #e8e8ed' }}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: 20, marginBottom: 10 }}>
            <a href="https://www.facebook.com/orva.dz" target="_blank" rel="noopener" style={{ color: '#E54E19', textDecoration: 'none', fontSize: 14, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <a href="https://instagram.com/orva.dz" target="_blank" rel="noopener" style={{ color: '#E54E19', textDecoration: 'none', fontSize: 14, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 6 }}>
