...
export default function ProductClient({ product, wilayas, communes}) {
        ...
        <div style={{ flex: '1 1 50%', minWidth: 0, width: '100%' }}>
          <div style={{ position: 'sticky', top: 80, background: '#fff', border: '1px solid #e5e5ea', boxShadow: '0 8px 40px rgba(0,0,0,0.08)' }}>
            ...
            <div style={{ textAlign: 'center', padding: '16px 20px 0' }}>
              <img src="/logo-ibi2.png" alt="ibishop" style={{ height: 90, display: 'block', margin: '0 auto 12px' }} />
            {/* Product title & price */}
  ...
  'sijada-salat': [],
  'word-box': [
    { name: 'آمنة ن.', city: 'الجزائر', rating: 5, text: 'ابني يتعلم تكوين الكلمات العربية. قطع خشبية متينة', date: 'منذ 3 أيام' },
    { name: 'حسين ل.', city: 'وهران', rating: 5, text: 'طريقة تفاعلية ممتازة. صغيري حب يتعلم بزاف', date: 'منذ أسبوع' },
    { name: 'كريمة ب.', city: 'قسنطينة', rating: 4, text: 'مفيد جداً. الخشب ذو جودة عالية وآمن', date: 'منذ أسبوعين' },
    { name: 'وليد ع.', city: 'البليدة', rating: 5, text: 'أفضل لعبة تعليمية. يساعد على القراءة والكتابة', date: 'منذ 3 أسابيع' },
  ],
  'plateau-lettres': [
  ...
  'jeu-differences-32': [
    ...
    { name: 'صليحة ع.', city: 'الشلف', rating: 5, text: 'بنتي تحب تلعب بيه كل يوم. شكراً ibishop', date: 'منذ 3 أسابيع' },
  ],
  'jeu-tri-animaux': [
  ...
  'cadre-dessin-enfant-a4': [
    ...
    { name: 'بهاء م.', city: 'الشلف', rating: 5, text: 'بناتي حطو رسوماتهم فيه. شكراً ibishop', date: 'منذ أسبوعين' },
  ],
  'cadre': [
